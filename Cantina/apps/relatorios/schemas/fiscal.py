...
class ResumoFiscalSchema(PeriodoSchema):
    ...
    descontos: Decimal = Field(default=0, ge=0)
    custo_mercadorias: Decimal = Field(default=0, ge=0)
    despesas_operacionais: Decimal = Field(default=0, ge=0)
    tributos_estimados: Decimal = Field(default=0, ge=0)
    lucro_bruto: Decimal
